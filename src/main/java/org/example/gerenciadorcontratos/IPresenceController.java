...
public interface IPresenceController {
    void createPresence(Presence presence) throws ConnectionFailureDbException, PresenceCreatedSuccessfullyException, InvalidPresenceException, PresenceNullException, InvalidPresenseOrRecordDateTimeException, EmptyfieldsException, ThereIsAlreadyARegisteredPresenceException, JustificationRequiredException;
    ...
    boolean checkPresenceData(Presence presence) throws EmptyfieldsException, InvalidPresenseOrRecordDateTimeException, ConnectionFailureDbException, ThereIsAlreadyARegisteredPresenceException, JustificationRequiredException;
