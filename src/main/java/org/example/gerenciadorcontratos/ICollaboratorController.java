...
public interface ICollaboratorController {
    void createCollaborator(Collaborator collaborator) throws ConnectionFailureDbException, CollaboratorCreatedSuccessfullyException, InvalidCollaboratorException, CollaboratorNullException, InvalidCpfException, CollaboratorWithThisCpfAlreadyExistsException, InvalidEmailException, EmptyfieldsException;
