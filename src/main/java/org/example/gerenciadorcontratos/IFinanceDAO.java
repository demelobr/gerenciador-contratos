...
public interface IFinanceDAO {
    ...
    void update(Finance finance, String title, String contractName, String type, LocalDate date, LocalDateTime recordDateTime, double value, String collaboratorCpf) throws ConnectionFailureDbException;
